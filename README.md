...
Este proyecto consiste en la implementación de un cronómetro web (stopwatch) desarrollado con HTML, CSS y JavaScript puro, sin frameworks ni librerías externas.
