...
ChatGPT (OpenAI — modelo GPT-5.3) → herramienta principal
...
Prompt 3 — Corrección conceptual
...
En algunos casos, menos preciso en implementación técnica
Conclusión de la comparación:

ChatGPT resultó más efectivo para la implementación práctica y rápida del código, mientras que Claude fue útil como apoyo para validar conceptos o revisar decisiones.
...
❌ Limitaciones
Interpretación incorrecta en etapas iniciales
